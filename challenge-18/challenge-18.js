(function () {
  ...
  */
  ...
  console.log(
    cleanCPF("049-214 3421-1").replace(
      /(\d{3})(\d{3})(\d{3})(\d{2})/,
  ...
  console.log(
    cleanCPF("210.458.522-05").replace(
      /(\d{3})(\d{3})(\d{3})(\d{2})/,
      function (regex, p1, p2, p3, p4) {
        return `${p1}.${p2}.${p3}-${p4}`;
      }
  ...
  console.log(
    cleanCPF("735 500 794 - 22").replace(
      /(\d{3})(\d{3})(\d{3})(\d{2})/,
      function (regex, p1, p2, p3, p4) {
        return `${p1}.${p2}.${p3}-${p4}`;
      }
  ...
  console.log(
    cleanCPF("101.123-131x32").replace(
      /(\d{3})(\d{3})(\d{3})(\d{2})/,
      function (regex, p1, p2, p3, p4) {
        return `${p1}.${p2}.${p3}-${p4}`;
      }
  ...
  */
  ...
  var vacationMonthRegex = /ju[nl]ho/g;
  console.log(
